...
export const WS_METHODS = {
  ...
  botMemoryTopicList: "bot.memoryTopicList",
  botMemoryTopicGet: "bot.memoryTopicGet",
  botControl: "bot.control",
  botAuditList: "bot.auditList",
  botCommsChannelList: "bot.commsChannelList",
  botCommsMessageList: "bot.commsMessageList",
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(WS_METHODS.botMemoryTopicList, BotMemoryTopicListInput),
  tagRequestBody(WS_METHODS.botMemoryTopicGet, BotMemoryTopicGetInput),
