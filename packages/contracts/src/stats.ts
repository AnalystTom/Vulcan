...
// the shareable activity card. All metrics are backed by Vulcan's local DB
...
export const ProfileActivity = Schema.Struct({
  ...
  // totalPromptsSent), i.e. days the user actually used Vulcan.
...
// Token totals come from Vulcan's projected context-window updates. `available`
