...
export const WS_COMPATIBILITY_QUERY = {
  clientBuild: "x-vulcan-client-build",
  protocolEpoch: "x-vulcan-protocol-epoch",
  protocolRevision: "x-vulcan-protocol-revision",
  serverInstanceId: "x-vulcan-server-instance",
} as const;

export const WS_NEGOTIATE_QUERY = {
  clientBuild: "x-vulcan-client-build",
  protocolEpoch: "x-vulcan-protocol-epoch",
  minRevision: "x-vulcan-protocol-min-revision",
  maxRevision: "x-vulcan-protocol-max-revision",
  requiredCapability: "x-vulcan-required-capability",
} as const;
