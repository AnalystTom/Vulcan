...
// Unified cross-provider skills catalog (Vulcan portable skills). Descriptors use
// `scope` to carry the origin label ("vulcan", "codex", "claude", "cursor", ...).
...
export const ProviderSkillsCatalogResult = Schema.Struct({
  skills: Schema.Array(ProviderSkillDescriptor),
  vulcanSkillsDir: Schema.optional(TrimmedNonEmptyString),
});
