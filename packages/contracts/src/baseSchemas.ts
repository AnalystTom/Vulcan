...
export const BotTaskId = makeEntityId("BotTaskId");
export type BotTaskId = typeof BotTaskId.Type;
export const BotAuditEntryId = makeEntityId("BotAuditEntryId");
export type BotAuditEntryId = typeof BotAuditEntryId.Type;
export const BotCommsChannelId = makeEntityId("BotCommsChannelId");
export type BotCommsChannelId = typeof BotCommsChannelId.Type;
export const BotCommsMessageId = makeEntityId("BotCommsMessageId");
export type BotCommsMessageId = typeof BotCommsMessageId.Type;
export const BotDelegationId = makeEntityId("BotDelegationId");
export type BotDelegationId = typeof BotDelegationId.Type;
export const BotPeerApprovalId = makeEntityId("BotPeerApprovalId");
export type BotPeerApprovalId = typeof BotPeerApprovalId.Type;
