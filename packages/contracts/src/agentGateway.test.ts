...
import {
  VulcanCapabilitiesResult,
  VulcanCreateThreadsInput,
  VulcanCreateThreadsResult,
  VulcanGatewayErrorResult,
  VulcanWaitForThreadsInput,
  VulcanWaitForThreadsResult,
} from "./agentGateway";

const decodeCreate = Schema.decodeUnknownSync(VulcanCreateThreadsInput);
const decodeWait = Schema.decodeUnknownSync(VulcanWaitForThreadsInput);
...
describe("agent gateway contracts", () => {
  ...
  it("decodes typed capability, creation, wait, and error results", () => {
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(VulcanCapabilitiesResult)({
        targetConstruction: {
          codex: {
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(VulcanCreateThreadsResult)({
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(VulcanWaitForThreadsResult)({
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(VulcanGatewayErrorResult)({
