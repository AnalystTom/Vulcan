...
const PATH_CAPTURE_START = "__VULCAN_PATH_START__";
const PATH_CAPTURE_END = "__VULCAN_PATH_END__";
 ...
 */
export const SHELL_ENVIRONMENT_HYDRATED_ENV_NAME = "VULCAN_PATH_HYDRATED";
...
function envCaptureStart(name: string): string {
  return `__VULCAN_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__VULCAN_ENV_${name}_END__`;
}
