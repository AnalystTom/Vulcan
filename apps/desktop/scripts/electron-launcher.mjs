// This file mostly exists because we want dev mode to say "Vulcan (Dev)" instead of "electron"
...
import { resolveVulcanDesktopFlavor, vulcanDesktopIdentity } from "@vulcan/shared/desktopIdentity";
...
const MICROPHONE_USAGE_DESCRIPTION =
  "Vulcan needs microphone access so you can record voice notes and transcribe them into the chat composer.";
