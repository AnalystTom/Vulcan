...
} from "@vulcan/shared/windowsCertificate";
import { prepareWindowsSafeProcess, resolveWindowsSystemRoot } from "@vulcan/shared/windowsProcess";

export { parseDistinguishedName } from "@vulcan/shared/windowsCertificate";
...
export function hardenElectronUpdater(
  ...
  const prototype =
    typeof updaterModule.BaseUpdater === "function"
      ...
      : null;
  if (prototype && !prototype.__vulcanSpawnSyncLogPatched) {
    ...
    prototype.__vulcanSpawnSyncLogPatched = true;
  }
