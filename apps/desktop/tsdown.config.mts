...
const sourcemapEnv = process.env.VULCAN_DESKTOP_SOURCEMAP?.trim().toLowerCase();
...
export default defineConfig([
  {
    ...
    define: {
      __VULCAN_WINDOWS_UPDATER_PUBLISHER__: JSON.stringify(windowsUpdaterPublisher),
    },
    noExternal: (id) => id.startsWith("@vulcan/"),
  },
  {
    ...shared,
