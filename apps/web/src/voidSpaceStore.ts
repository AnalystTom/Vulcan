...
// Layer: Web UI state
// Why: "Void" is Vulcan's word for "not filed yet", and it is the one Space label a user
...
import { SPACE_NAME_MAX_LENGTH } from "@vulcan/contracts";
...
const STORAGE_KEY = "vulcan:void-space:v1";
