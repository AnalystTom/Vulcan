...
import type { ProviderKind, ServerProviderStatus, ServerSettings } from "@vulcan/contracts";
...
describe("getVisibleProviderUpdateStatuses", () => {
  it("excludes providers hidden from Vulcan so unchecked providers do not nag", () => {
...
describe("shouldPromptProviderUpdate", () => {
  // Cursor and Antigravity self-update, so Vulcan has no registry to read a latest
  ...
  it("keeps prompting for providers Vulcan can prove are behind", () => {
