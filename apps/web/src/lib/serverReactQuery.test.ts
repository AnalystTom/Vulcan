...
import type { ServerConfig, ServerProviderStatus } from "@vulcan/contracts";
...
function makeServerConfig(providers: readonly ServerProviderStatus[]): ServerConfig {
  return {
    ...
    studioWorkspaceRoot: "C:\\Users\\tester\\Documents\\Vulcan\\Studio",
    worktreesDir: "C:\\VulcanDev\\worktrees",
    keybindingsConfigPath: "C:\\VulcanDev\\keybindings.json",
    keybindings: [],
    issues: [],
    providers,
    availableEditors: [],
...
describe("serverLocalServersQueryOptions", () => {
  ...
  it("uses visible polling while a Vulcan-owned project run is active", () => {
    const options = sidebarLocalServersQueryOptions({
