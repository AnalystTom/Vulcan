...
import { type ProjectId } from "@vulcan/contracts";
...
describe("resolveFirstSendTarget", () => {
  it("creates a managed date/slug chat project for a plain general chat first send", () => {
    ...
    expect(result).toMatchObject({
      kind: "create-project",
      creation: {
        workspaceRoot: "/Users/tester/Documents/Vulcan/2026-06-11/yes-it-takes-all-the-skills",
        title: "Yes it takes",
        kind: "chat",
  ...
  it("keeps a plain Studio first send in the Studio container", () => {
    ...
    expect(result).toMatchObject({
      ...
      target: {
        ...
        targetProjectCwd: "/Users/tester/Documents/Vulcan/Studio",
      },
    });
  });
