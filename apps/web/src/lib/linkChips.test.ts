...
describe("parseBareComposerLink", () => {
  it("returns the URL when the whole text is one bare link", () => {
    expect(parseBareComposerLink("https://github.com/AnalystTom/Agent_panel")).toBe(
      "https://github.com/AnalystTom/Agent_panel",
    );
  });
...
describe("describeLinkChip", () => {
  it("shortens GitHub pull request URLs to owner/repo#number", () => {
    expect(describeLinkChip("https://github.com/AnalystTom/Agent_panel/pull/155")).toEqual({
      label: "AnalystTom/Agent_panel#155",
      isGitHub: true,
    });
  });
