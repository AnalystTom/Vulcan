...
export const FAVORITE_MODEL_STORAGE_KEYS = {
  cursor: "vulcan:cursor-favourite-models:v1",
  kilo: "vulcan:kilo-favourite-models:v1",
  opencode: "vulcan:opencode-favourite-models:v1",
  pi: "vulcan:pi-favourite-models:v1",
} as const;
