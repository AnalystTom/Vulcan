...
// Purpose: Detects when a normal chat prompt is actually asking Vulcan to create an automation.
...
import { completionPolicyFromStopWhen } from "@vulcan/shared/automationCompletionPolicy";
