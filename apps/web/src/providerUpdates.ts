...
// A provider whose latest version Vulcan cannot look up (self-updating CLIs such as
...
// Header affordance: reserved for providers Vulcan can actually assert are outdated.
