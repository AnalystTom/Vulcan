...
export const SETTINGS_NAV_ITEMS: readonly SettingsNavItem[] = [
  ...
  },
  {
    ...
    group: "personal",
    label: "Notifications",
    description: "Choose how Vulcan tells you when work finishes or needs attention.",
    icon: "bell",
    eyebrow: "Alerts",
  },
  {
  ...
  },
  {
    ...
    group: "personal",
    label: "Keybindings",
    description: "Capture, customize, and add shortcuts for every Vulcan command.",
    icon: "shortcut",
  ...
  },
  {
    ...
    description: "Give Codex, Claude, and other local agents scoped access to Vulcan tasks.",
    icon: "plugin-1",
