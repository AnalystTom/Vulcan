...
export const SETTINGS_SEARCH_ENTRIES: readonly SettingsSearchEntry[] = [
  ...
  // ── Appearance ───────────────────────────────────────────────────────────────
  {
    ...
    section: "appearance",
    title: "Theme",
    keywords: "Choose how Vulcan looks across the app. dark light system color",
  },
  {
    id: "appearance:app-icon",
    section: "appearance",
    title: "App icon",
    keywords: "Choose the icon Vulcan uses in the dock or taskbar desktop application logo.",
    target: null,
  },
  {
    ...
    keywords: "Use the operating system interface font throughout Vulcan.",
  },
  {
  ...
  // ── Keybindings ───────────────────────────────────────────────────────────────
  {
    ...
    title: "Keybindings",
    keywords:
      "Every keyboard shortcut available in Vulcan, grouped by context. keybindings hotkeys key combo cmd ctrl reference",
    target: null,
  },
  ...
  // ── Worktrees ─────────────────────────────────────────────────────────────────
  {
    ...
    keywords: "Review and clean up the worktrees created by Vulcan. git branch remove",
    target: null,
  },
  ...
  },
  {
    ...
    keywords: "Update installed provider tools that Vulcan can safely update. upgrade cli",
  },
  {
