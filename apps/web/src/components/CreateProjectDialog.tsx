...
import { type GitHubProjectProvisionProgressEvent, type SpaceId } from "@vulcan/contracts";
import { parseGitHubRepositoryInput } from "@vulcan/shared/githubRepository";
...
export function CreateProjectDialog(props: {
  ...
  const submit = async () => {
    ...
    if (source === "github" && !props.githubProvisioningAvailable) {
      setFormError("Update the Vulcan server before adding a project from GitHub.");
      return;
    }
