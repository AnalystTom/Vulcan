...
import { isWorkspaceRootWithin, workspaceRootsEqual } from "@vulcan/shared/threadWorkspace";
 ...
 * without going through Vulcan's branch picker. In that case the worktree's checked-out branch
