...
/**
 * The compact raised-thumb picker previously used for the Vulcan/Studio switch,
        ...
        {PROJECT_SOURCES.map((source, index) => {
          ...
          return (
            <button
              ...
              title={
                sourceUnavailable ? "Update the Vulcan server to add GitHub projects." : undefined
              }
              className={cn(
