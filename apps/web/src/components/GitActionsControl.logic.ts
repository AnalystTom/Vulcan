...
import { isTemporaryWorktreeBranch, resolveUniqueVulcanBranchName } from "@vulcan/shared/git";
...
export function resolveDefaultCreateBranchName(
  ...
  return resolveUniqueVulcanBranchName(existingBranchNames, preferredBranch);
}
...
export { resolveAutoFeatureBranchName } from "@vulcan/shared/git";
