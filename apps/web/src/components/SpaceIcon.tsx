// FILE: SpaceIcon.tsx
// Purpose: Renders built-in and custom Space icons through Vulcan's Central asset renderer.

import { SPACE_ICON_NAMES, type SpaceIconName } from "@vulcan/contracts";
