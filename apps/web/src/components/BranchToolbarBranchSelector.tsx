...
import type { GitBranch, GitStashInfoResult, GitStatusResult, NativeApi } from "@vulcan/contracts";
            ...
            try {
              ...
              if (isStashConflictError(stashError)) {
                ...
                addBranchRecoveryToast({
                  ...
                  description:
                    "Vulcan switched branches and kept your changes in a stash because they could not be restored onto this branch cleanly.",
