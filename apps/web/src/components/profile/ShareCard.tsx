...
import type { ProfileStats, ProfileTokenStats } from "@vulcan/contracts";
    ...
    >
      ...
      <div className="flex min-w-0 items-center justify-between gap-6">
        ...
        <div className="flex shrink-0 items-center gap-2 text-slate-600">
          <VulcanLogo className="size-6 text-slate-700" />
          <span className="text-xl font-normal tracking-tight">Vulcan</span>
        </div>
      </div>
