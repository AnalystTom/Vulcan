...
import { resolveThreadBranchRegressionGuard } from "@vulcan/shared/git";
import {
  addPinnedMessage,
  removePinnedMessage,
...
import { isPendingInteractionResponseClaimable } from "@vulcan/shared/pendingInteractions";
import {
  addThreadMarker,
  removeThreadMarker,
  setThreadMarkerDone,
  setThreadMarkerLabel,
} from "@vulcan/shared/threadMarkers";
...
type ReadModelThread = import("@vulcan/contracts").OrchestrationReadModel["threads"][number];
