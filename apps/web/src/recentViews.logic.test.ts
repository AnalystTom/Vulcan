...
import type { ResolvedTerminalVisualIdentity } from "@vulcan/shared/terminalThreads";
import {
...
describe("recent view MRU logic", () => {
  ...
  it("prefers terminal visual identity over thread provider for display icons", () => {
    ...
    const project = { id: projectId("project-1"), name: "Vulcan" } as Project;
    const threadSummary = {
      id: terminalThreadId,
