...
import type { ProjectId, ProviderKind, ThreadId } from "@vulcan/contracts";
import { isProviderKind } from "./providerOrdering";

const EDITOR_VIEW_STATE_STORAGE_KEY = "vulcan.editor.viewStateByThreadId";
const EDITOR_RAIL_CHAT_TABS_STORAGE_KEY = "vulcan.editor.railChatTabsByProjectId";
