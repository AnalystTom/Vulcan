...
} from "@vulcan/shared/appSnapShortcut";
...
const APP_SETTINGS_STORAGE_KEY = "vulcan:app-settings:v1";
const SERVER_SETTINGS_MIGRATION_STORAGE_KEY = "vulcan:server-settings-migrated:v1";
...
export const AppSettingsSchema = Schema.Struct({
  ...
  // (rootless chats not tied to a project). The other flags control optional
  // surfaces in the section switcher.
  showChatsSection: Schema.Boolean.pipe(withDefaults(() => true)),
  showBotsSection: Schema.Boolean.pipe(withDefaults(() => true)),
...
const PROVIDER_CUSTOM_MODEL_CONFIG: Record<ProviderKind, ProviderCustomModelConfig> = {
  ...
  omp: {
    ...
    title: "OMP",
    description: "Save additional OMP model slugs for the picker and provider runtime.",
    placeholder: "provider/model",
    example: "qwen3090/qwen3.8-27b",
  },
};
