...
// Depends on: The public tryvulcan feedback endpoint.
...
export const FEEDBACK_CATEGORIES = [
  ...
  { value: "performance", label: "Performance", lead: "Vulcan felt slow" },
...
const DEFAULT_FEEDBACK_ENDPOINT = "https://github.com/AnalystTom/Agent_panel/api/feedback";
...
export function formatFeedbackSummary(input: {
  ...
  return [`${lead} in Vulcan ${diagnostics.appVersion}${usageContext}.`, "", ...detailLines].join(
    "\n",
  );
}
