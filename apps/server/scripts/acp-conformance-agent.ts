...
const logPath = process.env.VULCAN_ACP_CONFORMANCE_LOG_PATH;
const malformedPrefix = process.env.VULCAN_ACP_CONFORMANCE_MALFORMED_PREFIX === "1";
...
const app = agent({ name: "vulcan-official-sdk-conformance-agent" })
