...
import { resolveThreadWorkspaceCwd as resolveSharedThreadWorkspaceCwd } from "@vulcan/shared/threadEnvironment";

export const CHECKPOINT_REFS_PREFIX = "refs/vulcan/checkpoints";
