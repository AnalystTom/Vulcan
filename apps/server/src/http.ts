...
import { EDITOR_ICON_ROUTE_PATH } from "@vulcan/shared/editorIcons";
        ...
        return HttpServerResponse.jsonUnsafe(
          { error: authorization.reason === "unavailable" ? "Not Found" : "Unauthorized" },
          {
            ...
            ...(authorization.status === 401
              ? { headers: { "WWW-Authenticate": 'Bearer realm="vulcan-desktop-shutdown"' } }
              : {}),
          },
        );
      }
...
const threadExportEffectRouteLayer = HttpRouter.add(
  ...
  Effect.gen(function* () {
    ...
    // app fetches cross-origin (vulcan://app), and without them the browser masks
