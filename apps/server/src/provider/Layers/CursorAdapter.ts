...
export const takeCursorVulcanHarnessPolicyTextPart = (
...
// forever. Generous by design; override with VULCAN_CURSOR_TURN_IDLE_TIMEOUT_MS.
const CURSOR_TURN_IDLE_TIMEOUT_MS = resolveAcpTurnIdleTimeoutMs({
  envVar: "VULCAN_CURSOR_TURN_IDLE_TIMEOUT_MS",
  defaultMs: 600_000,
});
...
const CURSOR_PLAN_MODE_PROMPT_PREFIX = [
  "Vulcan Cursor plan mode is active.",
  ...
  return Effect.gen(function* () {
    ...
    const sendTurn: CursorAdapterShape["sendTurn"] = (input) =>
      Effect.gen(function* () {
        ...
        const harnessPolicy = takeCursorVulcanHarnessPolicyTextPart(
          ctx,
