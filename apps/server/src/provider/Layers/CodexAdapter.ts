...
import { vulcanSkillsDir } from "../skillsCatalog.ts";
...
// Generous by design; override with VULCAN_CODEX_TURN_IDLE_TIMEOUT_MS.
const CODEX_TURN_IDLE_TIMEOUT_MS = resolveAcpTurnIdleTimeoutMs({
  envVar: "VULCAN_CODEX_TURN_IDLE_TIMEOUT_MS",
  defaultMs: 900_000,
});
      ...
      Effect.gen(function* () {
        ...
        return (
          ...
          new CodexAppServerManager(services, {
            vulcanSkillsDir: vulcanSkillsDir(serverConfig.baseDir),
