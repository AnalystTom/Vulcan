...
import type { ChatAttachment, ProviderApprovalDecision, RuntimeMode } from "@vulcan/contracts";
import {
  type ConsoleState,
...
import { NetService, type NetServiceShape } from "@vulcan/shared/Net";
...
export class OpenCodeRuntime extends ServiceMap.Service<OpenCodeRuntime, OpenCodeRuntimeShape>()(
  "vulcan/provider/opencodeRuntime",
) {}
