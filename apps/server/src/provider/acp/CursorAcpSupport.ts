 ...
 */
import { type CursorModelOptions, type ProviderModelDescriptor } from "@vulcan/contracts";
import { formatModelDisplayName, parseCursorCliReasoningEffort } from "@vulcan/shared/model";
...
// Cursor exposes "auto" as a `default` model id over ACP; keep Vulcan's "auto"
