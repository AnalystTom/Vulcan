...
// Purpose: Bridges ACP form elicitation schemas to Vulcan's provider-neutral question UI.
...
// Converts primitive ACP form fields into the question shape consumed by Vulcan's composer.
