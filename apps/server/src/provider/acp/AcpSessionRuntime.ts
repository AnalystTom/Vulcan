...
export interface AcpSessionRuntimeOptions {
   ...
   * `mcpCapabilities` (e.g. HTTP vs stdio for the Vulcan agent gateway).
   */
...
/**
 * Bridges Effect's child-process exit signal into Vulcan's process-tree proof. This is deliberately
...
>()("vulcan/provider/acp/AcpSessionRuntime") {
  static layer(
