...
import type { ChatAttachment, ProviderKind, ThreadId } from "@vulcan/contracts";
...
const PROVIDER_ATTACHMENT_STORAGE_PATH = Symbol("vulcan.providerAttachmentStoragePath");
