...
import { isSupportedLocalImagePath as isSupportedLocalImagePathShared } from "@vulcan/shared/localPreviewFiles";
 ...
 * writes images under for the current process env. Vulcan uses its isolated
 ...
 * overlay `<VULCAN_HOME>/codex-home-overlay/generated_images` so we serve
