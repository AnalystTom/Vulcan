...
} from "@vulcan/shared/browserAutomationCatalogue";
import { makeBrowserAutomationError } from "@vulcan/shared/browserAutomationErrors";
import { encodeBrowserMcpToolError } from "@vulcan/shared/browserAutomationMcpError";
...
function withGatewayIdempotencyKey(
  ...
  return {
    ...argumentsValue,
    idempotencyKey: `vulcan-mcp-${digest.slice(0, 40)}`,
  };
}
