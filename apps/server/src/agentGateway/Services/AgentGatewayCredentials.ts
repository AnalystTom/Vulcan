/**
 * AgentGatewayCredentials - Per-session credentials for the Vulcan agent
 * gateway.
 *
...
export interface AgentGatewayCredentialsShape {
  /** Streamable-HTTP MCP endpoint served by this Vulcan instance. */
...
>()("vulcan/agentGateway/Services/AgentGatewayCredentials") {}
