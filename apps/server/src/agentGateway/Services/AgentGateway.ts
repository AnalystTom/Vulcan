/**
 * AgentGateway - Vulcan app-control tool surface for provider agents.
 *
 * Serves the `vulcan_*` MCP tools that let any provider session (Codex,
 * Claude, Grok, ...) inspect and control Vulcan itself: list projects and
...
export class AgentGateway extends ServiceMap.Service<AgentGateway, AgentGatewayShape>()(
  "vulcan/agentGateway/Services/AgentGateway",
) {}
