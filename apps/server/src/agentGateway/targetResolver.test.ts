...
import type { ModelSelection, ProviderKind, ProviderModelDescriptor } from "@vulcan/contracts";
...
describe("agent gateway target resolver", () => {
  ...
  it.effect("fails closed before discovery when Vulcan disables a provider", () =>
    Effect.gen(function* () {
