...
import type { ServerProviderUsageLimit, ServerProviderUsageLine } from "@vulcan/contracts";
...
// The token was already redeemed (by the CLI, or another Vulcan process): the file likely holds
