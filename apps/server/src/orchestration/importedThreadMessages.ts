...
// Purpose: Normalizes provider-native transcript snapshots into Vulcan import messages.
...
import { MessageId, type ThreadHandoffImportedMessage, type ThreadId } from "@vulcan/contracts";
