...
import { CommandId, ProjectId, SpaceId, type OrchestrationCommand } from "@vulcan/contracts";
...
describe("Spaces", () => {
  ...
  it("rejects filing a legacy Home chat container into a space", async () => {
    ...
    const workspacePaths = {
      homeDir: "/Users/dev",
      chatWorkspaceRoot: "/Users/dev/Documents/Vulcan/Chats",
    };
    let readModel = createEmptyReadModel(createdAt);
    ...
    ({ readModel } = await dispatch(readModel, {
      ...
      title: "Vulcan",
      workspaceRoot: "/Users/dev/code/vulcan",
      createdAt,
    }));
