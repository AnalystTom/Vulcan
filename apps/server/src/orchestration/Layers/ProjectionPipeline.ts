import { ApprovalRequestId, CommandId, type OrchestrationEvent } from "@vulcan/contracts";
import {
  addPinnedMessage,
  removePinnedMessage,
...
import { isStalePendingRequestFailureDetail } from "@vulcan/shared/threadSummary";
