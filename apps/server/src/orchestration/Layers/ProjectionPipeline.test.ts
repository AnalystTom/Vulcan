...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer("vulcan-projection-pipeline-test-");
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("vulcan-message-identity-scope-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("vulcan-approval-identity-scope-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "vulcan-projection-pipeline-fast-forward-",
        }),
        NodeServices.layer,
      ),
    ),
...
it.effect("drains 2,501 file-backed events to a captured high-water fence", () =>
  Effect.gen(function* () {
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "vulcan-projection-pipeline-paged-",
        }),
        NodeServices.layer,
      ),
    ),
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("vulcan-base-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("vulcan-projection-pipeline-approvals-")),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("vulcan-projection-attachments-safe-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("vulcan-projection-attachments-overwrite-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("vulcan-projection-attachments-rollback-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("vulcan-projection-attachments-revert-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("vulcan-projection-attachments-delete-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.effect("restores pending turn-start metadata across projection pipeline restart", () =>
  Effect.gen(function* () {
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "vulcan-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "vulcan-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("vulcan-projection-pipeline-turn-finish-")),
)("OrchestrationProjectionPipeline", (it) => {
