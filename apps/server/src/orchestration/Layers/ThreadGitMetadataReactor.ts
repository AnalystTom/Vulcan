import { CommandId, type ProviderRuntimeEvent, type ThreadId } from "@vulcan/contracts";
...
const make = Effect.gen(function* () {
  ...
  const processProviderEvent = (event: ProviderRuntimeEvent) => {
    // Native subagent lifecycle events carry the parent Vulcan thread id and the child identity
