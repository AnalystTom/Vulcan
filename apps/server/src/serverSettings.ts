...
import { deepMerge, type DeepPartial } from "@vulcan/shared/Struct";
import { applyServerSettingsPatch } from "@vulcan/shared/serverSettings";
import {
  Cause,
  Deferred,
  Effect,
...
export class ServerSettingsService extends ServiceMap.Service<
  ...
  ServerSettingsShape
>()("vulcan/serverSettings/ServerSettingsService") {
