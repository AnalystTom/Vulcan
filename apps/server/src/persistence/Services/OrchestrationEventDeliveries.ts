import { EventId, IsoDateTime, NonNegativeInt, ThreadId } from "@vulcan/contracts";
...
>()(
  "vulcan/persistence/Services/OrchestrationEventDeliveries/OrchestrationEventDeliveryRepository",
) {}
