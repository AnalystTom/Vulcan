...
import { IsoDateTime, NonNegativeInt, SpaceIconName, SpaceId, SpaceName } from "@vulcan/contracts";
...
>()("vulcan/persistence/Services/ProjectionSpaces/ProjectionSpaceRepository") {}
