 ...
 * names. Because the migrator skips by ID, Vulcan migrations 17-31 never run
 ...
 * Vulcan migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh Vulcan installs (every column already
