...
export interface FactoryWorkspacesShape {
  /**
...
export class FactoryWorkspaces extends ServiceMap.Service<
  FactoryWorkspaces,
  FactoryWorkspacesShape
>()("vulcan/factory/Services/FactoryWorkspaces/FactoryWorkspaces") {}
