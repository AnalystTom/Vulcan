...
export class CodexTextGeneration extends ServiceMap.Service<
  CodexTextGeneration,
  TextGenerationShape
>()("vulcan/git/Services/TextGeneration/CodexTextGeneration") {}
...
export class OpenCodeTextGeneration extends ServiceMap.Service<
  ...
  TextGenerationShape
>()("vulcan/git/Services/TextGeneration/OpenCodeTextGeneration") {}
...
export class KiloTextGeneration extends ServiceMap.Service<
  KiloTextGeneration,
  TextGenerationShape
>()("vulcan/git/Services/TextGeneration/KiloTextGeneration") {}
