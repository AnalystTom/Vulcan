...
const USAGE = "Usage: vulcan-restore-migration-backup <absolute-database-path>";
const STOP_PROCESSES_WARNING =
  "WARNING: Stop every Vulcan process before restoring a migration backup.";
...
const entryPointNames = new Set([
  ...
  "vulcan-restore-migration-backup",
]);
